...
def frame_inspect_tool(
    ...
    p = get_prompts()
    input_msgs = [
        {"role": "system", "content": p.frame_inspect_system},
        {"role": "user", "content": p.frame_inspect_user_template},
    ]
...
def global_browse_tool(
    ...
    p = get_prompts()
    input_msgs = [
        {"role": "system", "content": p.global_browse_system},
        {"role": "user", "content": p.global_browse_user_template},
    ]
